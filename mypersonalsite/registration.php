                ...
                <div class="container">
                    <div class="row">
                        <div class="section-title text-center">
                            <h3>Registration</h3>
                            <p><b>[Registration with us]<b></b></p>
                        </div>
                    </div>
                    <div class="row">
...
?>
      ...
      <td colspan="2">
          ...
          <tr>
            ...
            <input type="checkbox" name="hobby[]" value="Playing"><label>Playing</label>
 <input type="checkbox" name="hobby[]" value="Coding"><label>Coding.</label>
 <input type="checkbox" name="hobby[]" value="Reading"><label>Reading</label>
 <input type="checkbox" name="hobby[]" value="Hacking"><label>Hacking</label>
 <input type="checkbox" name="hobby[]" value="Sleeping"><label>Sleeping</label></td></tr>
                 ...
                 <div class="col-md-5 col-md-offset-1">
                     <nav>
                         <ul class="pagination">
                             ...
                             <li><a href="contact.php.php">9</a></li>
